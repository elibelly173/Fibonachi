...
.service('problemservice32', function($rootScope, $localStorage) {
    ...
    var generatenumber= function(selectlevel){
        //number array for problem
        var numbers=[];
        var firstNumber, secondNumber, thirdflag, firstPow;
        var answer;
        do {
            // first number of problem
            ...
            thirdflag = Math.floor(Math.random() * (1 + 1)) + 0;
            if(thirdflag == 1){
                numbers[0] = firstNumber/Math.pow(10, firstPow);
                numbers[1] = secondNumber;
            } else {
                numbers[0] = firstNumber;
                numbers[1] = secondNumber/Math.pow(10, firstPow);
            }


            answer = numbers[0] * numbers[1];
            numbers[2] = firstNumber * secondNumber/Math.pow(10, firstPow);
